...
<body style="min-width: 600px;">
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 查看课程项
	</nav>
	...
	<form id="editForm" class="form form-horizontal">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"  placeholder="" name="name" value="${course.name }" readonly />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text"  placeholder="" name="description" value="${course.description }" readonly />
				</div>
			</div>
	</form>
	</article>
