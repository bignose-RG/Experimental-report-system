		...
		<form id="editForm" class="form form-horizontal">
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input name="userId" type="text" class="input-text" id="teacherUserId" value="${teacher.userId}"/>
					<input name="id" type="text" style="display: none"
					class="input-text" id="teacherId" value="${teacher.id}"/>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input  name="name" type="text" id="teacherName" class="input-text" value="${teacher.name}"/>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select name="sex" class="input-text" id="sex">
						<option value="1" ${teacher.sex==1?"selected":''} >男</option>
						<option value="2" ${teacher.sex==2?"selected":''} >女</option>
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input  name="phoneno" type="text" id="phoneno" class="input-text" value="${teacher.phoneno}"/>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input  name="email" type="text" id="email" class="input-text" value="${teacher.email}"/>
				</div>
			</div>
	</form>
	</article>
