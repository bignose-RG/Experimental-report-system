...
<body style="min-width: 600px;">
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span> 学生信息修改
	</nav>
	<article class="page-container">
		<form id="editForm" class="form form-horizontal">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input  name="name" type="text" id="studentName" class="input-text" value="${studentVo.name}"/>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<select name="sex" class="input-text" id="sex">
						<option value="1" ${studentVo.sex==1?"selected":''} >男</option>
						<option value="2" ${studentVo.sex==2?"selected":''} >女</option>
					</select>
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input  name="phoneno" type="text" id="phoneno" class="input-text" value="${studentVo.phoneno}"/>
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input  name="email" type="text" id="email" class="input-text" value="${studentVo.email}"/>
				</div>
			</div>
	</form>
	</article>
