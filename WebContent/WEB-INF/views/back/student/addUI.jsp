...
<body style="min-width: 600px;">
	<nav class="breadcrumb">
		...
		<span class="c-gray en">&gt;</span>学生添加
	</nav>
<article class="page-container">
	<form class="form form-horizontal" id="addForm">
		<div class="page-container_tittle">
				<i class="firm_det_tit_line"></i>添加学生
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select name="department.encryptId" class="select" id="depart">
					<option value="">--选择学院--</option>
					<c:forEach var="depart" items="${departs}">
						<option value="${depart.encryptId}"
							${depart.encryptId==studentVo.depart.encryptId?'selected="selected"':'' }>${depart.name}</option>
					</c:forEach>
				</select>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>专业：</label>
				<div class="formControls col-xs-8 col-sm-9">				
					<select name="major.encryptId" class="select" id="major">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>班级：</label>
				<div class="formControls col-xs-8 col-sm-9">				
					<select name="studentClass.encryptId" class="select" id="studentClass">
		...
		$.ajax({
			...
			success : function(data) {
				if(data.msg!=null && data.msg!=""){
					top.layer.alert("该学号已存在，请重新填写。", {icon: 2});
				}
			}
			});
		});
