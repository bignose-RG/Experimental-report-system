...
<article class="page-container">
	<form class="form form-horizontal" id="selectCourseForm">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>重修课程：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>重修题目：</label>
			<div class="formControls col-xs-6 col-sm-5">
