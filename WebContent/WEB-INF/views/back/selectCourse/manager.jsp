...
<body>
	...
	<span class="c-gray en">&gt;</span> 选课查看
	...
	<div class="page-container">
		...
		<div class="mt_right" style="float: right;">
			<form action="${staticPath}/back/report/submitList" id="pageForm" style="float: right;" method="post">
				<label class="mt_label">课程编号：</label> 
					<input name="coursecode" value="${selectCourseVo.coursecode}" class="mt_select mt_input" type="text" placeholder="请输入..." /> 
				<label class="mt_label">课程名称：</label> 
					<input name="coursename" value="${selectCourseVo.coursename}" class="mt_select mt_input" type="text" placeholder="请输入关键字..." />
				<label class="mt_label">学年：</label> 
					<input name="year" value="${selectCourseVo.year}" class="mt_select mt_input" type="text" placeholder="请输入关键字..." />
				<label class="mt_label">学期：</label> 
					<input name="term" value="${selectCourseVo.term}" class="mt_select mt_input" type="text" placeholder="请输入关键字..." />
	...
	<script type="text/javascript">
		function jumpUrl() {
			top.layer.closeAll();
			window.location.href = "${staticPath}/back/report/submitList";
		}
