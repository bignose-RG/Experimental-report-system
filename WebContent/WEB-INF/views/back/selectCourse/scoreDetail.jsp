...
<nav class="breadcrumb">
	...
	<span class="c-gray en">&gt;</span>报告查阅 <span style="margin-left:120px;font-size:20px;color:red;">${student.userId}-${student.name}</span>
</nav>
<article class="page-container">
	...
	<form  class="form form-horizontal">
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<c:if test="${experiment.repetition != null}">
					<input type="text" class="input-text"  value="${experiment.repetition}" name="repetition" id ="repetition" readonly/>
				</c:if>
				<c:if test="${experiment.repetition == null}">
					<input type="text" class="input-text"  value="未查重或者重复率低于50%" name="repetition" id ="repetition" readonly/>
				</c:if>
			</div>
		</div>
	</form>
	<form action="${staticPath }/back/report/upcc" class="form form-horizontal"  target="result_win" id="scoreForm" method="POST">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">评阅结果:</label>
			<div class="formControls col-xs-4 col-sm-6">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-4 col-sm-6">
				<input type="text" class="input-text"  value="${experiment.score}" name="score" id ="score" readonly/>
			</div>
