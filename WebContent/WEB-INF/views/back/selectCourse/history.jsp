...
<body>
	...
	<i class="Hui-iconfont" style="color: #000;">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>作业查看
	</nav>
	<div class="page-container">
		...
		<div class="mt_right" style="float: right;">
			<form action="${staticPath}/back/report/historyrecord" id="pageForm" style="float: right;" method="post">
							...
							<tr class="text-c">
								...
								<td class="f-14 td-manage">
									...
									<c:if test="${selectCourse.score==null and selectCourse.status==1}">
										<a href="javascript:void(0);" idVal="${selectCourse.id}" class="tablelink update" title="修改">
										<i class="icon Hui-iconfont" style="color: #000;">&#xe6df;</i></a>
									</c:if>
								</td>
							</tr>
	...
	<script type="text/javascript">
		...
		$(".experimentSearch").click(function() {
			...
			top.layer.open({
				title: false,
				type: 2, shadeClose: true, shade: 0.3, area: ['800px', '60%'],
				content: rootPath+'/back/report/scoreDetail1/'+ id, 
				btn: ['取消'],
				 end: function () {
				        location.reload();
				      }
