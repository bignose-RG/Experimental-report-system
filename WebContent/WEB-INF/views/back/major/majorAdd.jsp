...
<nav class="breadcrumb">
	...
	<span class="c-gray en">&gt;</span>添加专业
</nav>
<article class="page-container">
	<form class="form form-horizontal" method="post" action="${staticPath}/back/major/majorAdd" id="addForm">
		<input type="hidden" name="id" value="${major.id }"/>
		<div class="page-container_tittle">
			<i class="firm_det_tit_line"></i>添加专业
		</div>
		<div class="row cl">
